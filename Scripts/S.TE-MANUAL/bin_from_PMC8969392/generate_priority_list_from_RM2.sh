...
# generate genome coverage list
while IFS= read -r str; do
    awk -v target="$str" '$1 == target { sum += ($9 > $10 ? $9 - $10 : $10 - $9) } END { print sum+0 }' genome.blast.o
done < col1.txt > col5.txt
...
paste -d "\t" col1.txt col2.txt col3.txt col4.txt col5.txt > final_priority.table.tab
